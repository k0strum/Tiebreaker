...
import OAuthAdditionalInfo from './pages/auth/OAuthAdditionalInfo.jsx'
...
const AppContent = () => {
  ...
  // 헤더를 숨길 경로들
  const hideHeaderPaths = ['/login', '/signup', '/signup-complete', '/verify-email', '/reset-pw', '/admin', '/oauth-callback', '/oauth-additional-info'];
