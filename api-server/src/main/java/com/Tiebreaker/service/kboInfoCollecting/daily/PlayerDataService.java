...
public class PlayerDataService {
  ...
  private void saveBatterCalculatedStats(Player player, BatterCalculatedStatsDto batterCalculatedStatsDto) {
    ...
    batterCalculatedStats.setBattingAverageWithRunnersInScoringPosition(batterCalculatedStatsDto.getBattingAverageWithRunnersInScoringPosition());
  ...
  private void savePitcherStats(Player player, PitcherStatsDto pitcherStatsDto) {
    ...
    pitcherStats.setInningsPitched(pitcherStatsDto.getInningsPitched());
